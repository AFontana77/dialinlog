        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              Contact: <a href="mailto:support@dialinlog.com" className="text-orange-700 hover:underline">support@dialinlog.com</a>
            </p>
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this policy? Email <a href="mailto:support@dialinlog.com" className="text-orange-700 hover:underline">support@dialinlog.com</a>.
            </p>
          </div>
        </section>
      </main>
