        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              These Terms of Service govern your use of the DialInLog espresso shot log app and the website at dialinlog.com.
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Anvil Road LLC operates dialinlog.com and the DialInLog mobile application.
              Contact: <a href="mailto:support@dialinlog.com" className="text-amber-700 hover:underline">support@dialinlog.com</a>
            </p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">2. Use of the Service</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              DialInLog is a personal espresso shot log app. You may use the service for personal, non-commercial purposes only.
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              DialInLog offers a one-time in-app purchase ($6.99 USD) to unlock the full database and premium logging features.
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              All content, design, code, and database records in the DialInLog app and website are owned by Anvil Road LLC
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              DialInLog is provided "as is" without warranties of any kind. Anvil Road LLC is not liable for any damages
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about these terms? Email <a href="mailto:support@dialinlog.com" className="text-amber-700 hover:underline">support@dialinlog.com</a>.
            </p>
          </div>
        </section>
      </main>
