...
/**
 * Marketing signup for dialinlog.com.
 *
 ...
 */
const RESOURCE = {
  title: 'Your Espresso Dial-In Tracker',
  blurb: 'The brew ratio reference, a table for reading a bad shot, and a log with room for fourteen pulls.',
  url: 'https://www.dialinlog.com/dialinlog-espresso-dial-in-tracker.pdf',
};
